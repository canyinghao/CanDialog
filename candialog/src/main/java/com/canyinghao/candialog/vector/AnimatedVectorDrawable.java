package com.canyinghao.candialog.vector;
...
public class AnimatedVectorDrawable extends DrawableCompat implements Animatable, Tintable {
    ...
    public void setTheLayoutDirection(int layoutDirection) {
        mAnimatedVectorState.mVectorDrawable.setTheLayoutDirection(layoutDirection);
    }
